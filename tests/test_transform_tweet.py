...
class TransformTweetTestCase(unittest.TestCase):
    ...
    def test_convert_created_at(self):
        ...
        self.assertEqual(
            json.loads(status_convert_created_at),
        ...
        #
        delete_tweet = (
            '{"delete":{"status":{"id":123,"id_str":"123","user_id":321,"user_id_str":"321"},'
            '"timestamp_ms":"000"}}'
        )
        ...
        self.assertEqual(
            json.loads(delete_tweet), json.loads(delete_convert_created_at)
        )
        ...
        self.assertEqual(
            json.loads(unknown_tweet), json.loads(unknown_convert_created_at)
        )
