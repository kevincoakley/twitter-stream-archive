...
class ExceptionsTestCase(unittest.TestCase):
    ...
    def test_local_file_exception(self):
        with self.assertRaises(twitterstreamarchive.exceptions.LocalFileException) as se:
    ...
    def test_local_twitter_exception(self):
        with self.assertRaises(twitterstreamarchive.exceptions.LocalTwitterException) as se:
